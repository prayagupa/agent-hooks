...
| --- | --- | --- | --- |
| Spec | `MAJOR.MINOR` | `spec/vX.Y.0` | MINOR = additive optional fields, new L2/L3, new vectors. MAJOR = L0/L1 change, hook-point add/remove, verdict-shape change. |
...
`HookContext.spec` value it emits and validates.
