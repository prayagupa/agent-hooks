...
# is held by an unrelated project (distribution rename pending).
pip install "agent-hooks[ctk] @ git+https://github.com/responsibleai/agent-hooks#subdirectory=sdk/python"
